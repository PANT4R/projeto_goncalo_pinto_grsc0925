...
sudo nmcli connection modify ens33 ipv4.method manual ipv4.addresses 192.168.5.1/24
sudo nmcli connection modify ens33 +ipv4.addresses 192.168.5.1/24
...
#backup
echo " Backup do arquivo de configuração DHCP-KEA"
...
sudo systemctl start --now kea-dhcp4
